...
const Profile = () => {
  ...
  return (
    <>
      <Row
        className=" rounded shadow  bg-light "
        style={{
          minHeight: "30rem",
          backgroundImage:
            "url('https://www.pngkey.com/png/full/336-3369684_home-web-design-education-website-background.png')",
      ...
      >
        ...
        <Col lg={12} className="my-3" style={{ borderRadius: "15px" }}>
          <div className="d-flex justify-content-between py-1 px-3">
            <Typography className="text-muted text-uppercase py-1" variant="h5">
              {userInfo.name}
            </Typography>
